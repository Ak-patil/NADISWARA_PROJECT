...
export const CHECK_USER_DEVICE_REQUEST = "CHECK_USER_DEVICE_REQUEST";
export const CHECK_USER_DEVICE_SUCCESS = "CHECK_USER_DEVICE_SUCCESS";
export const CHECK_USER_DEVICE_ERROR = "CHECK_USER_DEVICE_ERROR";
